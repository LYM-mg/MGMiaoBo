...
#pragma mark - MGGPUBeautifyFilter
@interface MGGPUBeautifyFilter()
{
...
@implementation MGGPUBeautifyFilter
- (instancetype)init;
{
    if (self = [super init]) {
...
#pragma mark - GPUImageInput protoco
